...
import {
  ...
  ViewManager,
  State,
  RNCCDWebViewUIManagerIOS,
} from './WebViewTypes';

import styles from './WebView.styles';

const UIManager = NotTypedUIManager as RNCCDWebViewUIManagerIOS;
...
const RNCCDWebView: typeof NativeWebViewIOS = requireNativeComponent(
  'RNCCDWebView',
);
